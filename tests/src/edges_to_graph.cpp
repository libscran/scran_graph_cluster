...
TEST(EdgesToGraph, Basic) {
    ...
    auto out = scran_graph_cluster::edges_to_graph(stuff.size(), stuff.data(), 10, false);
    ...
    auto cout = scran_graph_cluster::edges_to_graph(cstuff.size(), cstuff.data(), 10, true);
